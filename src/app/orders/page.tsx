...
import { demoRecentOrders } from '@/lib/demo-data';
...
export default function OrdersPage() {
  ...
  const filteredOrders = demoRecentOrders.filter(
    (order) =>
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500">Gestiona todas las órdenes de Shopify</p>
          </div>
